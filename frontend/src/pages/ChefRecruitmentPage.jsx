    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {applications.map((app) => (
          <div
            key={app._id}
            className="bg-white shadow-md rounded-lg overflow-hidden p-4 border border-gray-200 flex flex-col"
          >
            ...
            <div className="mt-4 flex justify-between">
              <button
                className="bg-green-500 text-white px-4 py-2 rounded flex-grow mr-2"
                onClick={() => handleApproval(app._id)}
              >
                Approve
              </button>
